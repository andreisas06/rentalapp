...
class Constants {
  static List<Property> propertyList = [
    ...
    Property(
      id: 3,
      amount: 500,
      address: 'Strada Erou Iancu Nicolae',
      minBook: 21,
      squaremeters: 55,
    ),
    Property(
